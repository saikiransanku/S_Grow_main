...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Preprocess seasonal plant disease images.")
    parser.add_argument("--season", default="kharif", choices=sorted(VALID_SEASONS))
...
def main() -> dict:
    ...
    input_root = args.input_root or (repo_root / "data" / "datasets" / "image_prediction_seasonal_dataset" / season)
    output_root = args.output_root or (repo_root / "data" / "datasets" / "Pre_train_data")
